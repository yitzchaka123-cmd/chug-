...
export const agreementSections: readonly AgreementSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      { id: "payment-total", text: `Total for the choir year: ${formatAmount(payment.choirYearTotal)}₪ per girl.` },
      { id: "payment-first-month", text: `The first payment is ${formatAmount(payment.registrationFeeAmount)}₪ - your trial month. From the second month, participation becomes a commitment for the rest of the choir year: it can no longer be cancelled, and the monthly payments continue through the end.` },
      { id: "payment-security-check", text: `Alongside the monthly payments, we ask for one security check covering the ${payment.securityCheckMonths} balance after the registration payment. For 2026–2027 the security check amount is ${formatAmount(payment.securityCheckAmount)}₪. It is a safety net only - never used unless an agreed payment stays unpaid, and we will always speak with you first.` },
  ...
  },
  {
    title: "Communication",
    paragraphs: [
      { id: "communication", text: "Every group gets its own WhatsApp group for updates, schedule notices and important information. And for anything at all - call me, Nechama, at 053-590-6149. I’m always happy to talk." },
    ],
  },
  {
    title: "Recordings",
    paragraphs: [
      { id: "recordings", text: "Rehearsals and performances may be recorded (audio and video). If recordings are shared, they stay private - within the parents’ WhatsApp groups, or sent privately to families considering joining, so they can see what the Chug is like." },
    ],
  },
  {
    title: "Behavior & Participation",
    paragraphs: [
      { id: "behavior", text: "We want the Choir Chug to be fun, warm and positive - a place where every girl feels comfortable. We expect the girls to treat the teacher and each other with respect, and if a behavior issue keeps disrupting, we’ll speak with the parents to find the best way forward together." },
    ],
  },
  {
    title: "Transportation & Responsibility",
    paragraphs: [
      { id: "transportation", text: "Travel to and from choir is the parents’ responsibility - please make sure your daughter knows her route. She should arrive at lesson time (not early) and head home straight afterward, since we aren’t able to supervise the girls before or after class." },
    ],
  },
] as const;
...
export const agreementVersion = "2026-2027-v3";
